                    ...
                    <div class="row">
                        ...
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h1><span style="padding:10px;"></span><?php echo $dashboardrm;?></h1>
                        ...
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h1><span style="padding:10px;"></span><?php echo $eleavesrm;?></h1>
                            </div>
                        </div>
                        <!--current balance FSS-->
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h1><span style="padding:10px;"></span><span><?php echo $rejectrm;?></span></h1>
                            </div>
                        </div>
                        ...
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="tile-stats">
                                ...
                                <h1><span style="padding:10px;"></span><span><?php echo $byrm;?></span></h1>
                            </div>
                        </div>
                        <!--
                        <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
