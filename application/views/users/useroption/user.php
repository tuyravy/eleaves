                      ...
                      <tbody>
                        ...
                        <tr id="tbody">
                          ...
                          <td style="text-align:center">
                            ...
                            <a href="#" id="reject" data-id="<?php echo $row->user_id;?>" class="btn btn-danger btn-xs">
                                <span class=" glyphicon glyphicon-remove" data-toggle="tooltip" data-placement="top" title="Remove User"></span> 
                            </a>
                              
                            <a href="<?php echo site_url('user/editusers')?>/<?php echo $row->user_id;?>" class="btn btn-primary btn-xs">
