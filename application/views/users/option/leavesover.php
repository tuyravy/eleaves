 ...
 <link rel="stylesheet" href="<?php echo base_url();?>dist/sweetalert.css">
            <div class="clearfix"></div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-eye" aria-hidden="true"></i><span style="margin-left:10px;">Branch not yet approve leave it over day.</span></h2>
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead >
                        <tr style="border-bottom:3pt solid #22d4ae;">
                          ...
                          <th style="text-align:center">Number of Staff</th>                          
                      ...
                      <tbody id="looptr">
                        ...
                        <tr id="tbody" style="text-align:center">
                          ...
                          <td id="center"><?php echo $row->NumberofStaff;?>
                          </td>                                        
