          ...
          <div class="">
            <div class="clearfix"></div>
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2><i class="fa fa-floppy-o" aria-hidden="true"></i><span style="margin-left:10px;">Views Detail Eleaves</span></h2>
                     ...
                     <div class="col-md-3">
                      ...
                      <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3" id="in">
                              ...
                              <img src="<?php echo base_url();?>assets/img/logo/user.png" class="img-responsive" style="margin-left:50px;">
                        
                          <h3 id="in"><?php echo $staffname->staff_nameeng;?></h3>
                        </div>
                    </div> 
                    <br/>
                  <div class="row">   
