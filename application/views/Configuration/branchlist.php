<script src="<?php echo base_url();?>public/vendors/jquery/dist/jquery.min.js"></script>
            <div class="clearfix"></div>
              <div class="col-md-12 col-sm-12 col-xs-12 nopadding">
                <div class="x_panel">
                    <div class="x_title">
                      <h2><i class="fa fa-list" aria-hidden="true"></i><span style="margin-left:10px;">Branch Configuration</span></h2>
                        ...
                        <div class="row">
                            <fieldset class="scheduler-border">
                                ...
                                <div class="table-responsive"> 
                                        ...
                                        <li class="active"><a href="<?= site_url('brnachlist');?>"><i class="fa fa-list"></i> Branch list</a></li>
                                        <li ><a href="<?= site_url('brnachmap');?>"><i class="fa fa-map-marker"></i> Branch Map</a></li>
                                        </ul>
                                            ...
                                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center"><?php if($row->flag==1){echo "Active";}else{echo "Inactive";};?></td>
